...
import { RoomDetail } from "@/components/room-detail.tsx";
import { RoomsList } from "@/components/room-list.tsx";
...
export function WarehouseDetailPage() {
  ...
  const handleBack = () => {
    switch (navigation.level) {
      case "equipment":
        setNavigation((prev) => ({ ...prev, level: "rack", selectedEquipment: undefined }));
        break;
      case "rack":
        setNavigation((prev) => ({ ...prev, level: "room", selectedRack: undefined }));
        break;
      case "room":
        setNavigation((prev) => ({ ...prev, level: "warehouse", selectedRoom: undefined }));
        break;
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        {navigation.level === "rack" && navigation.selectedRack && (
          <RackDetail rack={navigation.selectedRack} onEquipmentSelect={(equipment) => handleNavigate({ level: "equipment", selectedEquipment: equipment })} />
        )}
