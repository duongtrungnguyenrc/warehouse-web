...
const getStatusIcon = (status: InboundStatus) => {
  switch (status) {
    case "COMPLETED":
...
export const InboundPage = () => {
  ...
  const handleExport = async (batchId: string) => await download(() => InboundService.exportOrder(batchId));
    ...
    <div className="space-y-6">
      ...
      <div className="flex space-x-4">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search by batch number or supplier..." className="pl-10 bg-white" />
        </div>
        <DateRangePicker />
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Inbound Order List</CardTitle>
          <CardDescription>Track the status of inbound orders</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
